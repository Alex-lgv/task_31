...
import { Status } from '../statusAndRole';
...
export class Task extends BaseModel {
  ...
  static getTaskById(id) {
    let task = null;
    for (const t of this.getListOfTasks()) {
      if (t.id == id) {
        task = t;
      }
    }
  ...
  static getListTaskForBackLog() {
    let listTask = [];
    for (let task of Task.getListOfTasks()) {
